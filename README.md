...
| `IMPRINT_URL`                         |                             | Address that will be used in the imprint link. Will only show the link, if a value ahs been set.                                                                                                                                   | optional |
| `DATA_PRIVACY_URL`                    |                             | Address that will be used in the data privacy link. Will only show the link, if a value ahs been set.                                                                                                                              | optional |
