...
| 1.3     | 25.03.2026 | Julian Schumacher | Update faulty requirement IDs                                   |
...
5. [Functional Requirements](#5-functional-requirements)
   ...
   5.10 [AAS Repositories (REPO)](#510-aas-repositories-repo)
...
| SHOP-FR-007    | The system shall display product prices                               | In the product overview there shall be a price attribute displayed for each product, which is also reflected in the cart view, if the eShop module is active.               |     |
| SHOP-FR-008    | Accessible via `/cart` route                                          | The shopping cart feature shall be accessible via the `/cart` route of the system                                                                                           |
| SHOP-FR-009    | implement required data structures                                    | Required data structures for the card feature shall be added. Already existing data structure shall be used where applicable                                                |
| SHOP-FR-010    | caching cart content locally                                          | The shopping cart feature shall store the current content of the cart using the local storage mechanism                                                                     |
| SHOP-FR-011    | Menu Bar Icon incl. badge                                             | A new icon shall be added to the menu bar to navigate to the cart and indicate the current number of items in the cart                                                      |
| SHOP-FR-012    | Navigating via menu bar icon                                          | clicking the menu bar icon shall navigate to the `/cart` route specified in FR-024                                                                                          |
| SHOP-FR-013    | Realtime update                                                       | The cart and its content shall update in realtime                                                                                                                           |
| SHOP-FR-014    | No empty card badge                                                   | When the cart is empty the badge defined in SHOP-FR-021 shall not be displayed                                                                                              |
| SHOP-FR-015    | Cart overview                                                         | The shopping cart view (which access is defined in FR-024) shall display a preview of items including multiple relevant information such as product name, quanity and price |
| SHOP-FR-016    | total price display                                                   | The total price of the cart shall be displayed in a sum at the bottom of the view                                                                                           |
| SHOP-FR-017    | remove items from shop                                                | the user shall be provided with the option to remove each item in the cart individually                                                                                     |
| SHOP-FR-018    | adjust item count                                                     | the item count per item in the cart shall be adjustable by using a numberic input field                                                                                     |
| SHOP-FR-019    | checkout (preperation)                                                | the cart shall implement a "checkout" button to procede to checkout. The actual checkout is not within the scope of this implementation.                                    |
| SHOP-FR-020    | empty cart message                                                    | If the cart is empty, a message stating that the cart is empty shall be displayed                                                                                           |
| SHOP-FR-021    | responsive design                                                     | the shopping cart view shall be responsive to work on both mobile and desktop                                                                                               |
| SHOP-FR-022    | add product button                                                    | within the scope of this implementation, a "add to cart" button shall be implemented into the product detail view to add a product to the cart                              |
| SHOP-FR-023    | navigate to cart option after adding procuct                          | after adding a product to the cart the user shall be provided with the option to either navigate to the cart of stay on the current page                                    |
| SHOP-FR-024    | disable shopping cart feature                                         | the shopping cart feature shall provide a flag to disable the use of this feature                                                                                           |
