...
The Mnestix API currently includes the following component:
...
Mnestix offers a feature flag that allows configuration of whether authentication is required for the API. You can find the feature flags in your `compose.yml`. Set them to `true` or `false` to define the behavior of Mnestix:
