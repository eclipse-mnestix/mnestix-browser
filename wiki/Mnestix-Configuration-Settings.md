...
| `THEME_MENU_COLOR`                    | `THEME_PRIMARY_COLOR`   | This variable **overwrites** the color of the Header and the Menu (normally the same as `THEME_PRIMARY_COLOR`) in order to supoort whitelabelling with brighter colors / colors that conflict with the logo |
