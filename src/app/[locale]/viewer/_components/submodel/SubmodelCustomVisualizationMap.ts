...
import { HandoverDocumentationDetail } from './handover-documentation/HandoverDocumentationDetail';
...
export const submodelCustomVisualizationMap = {
    ...
    [SubmodelSemanticIdEnum.HandoverDocumentationV12]: HandoverDocumentationDetail,
