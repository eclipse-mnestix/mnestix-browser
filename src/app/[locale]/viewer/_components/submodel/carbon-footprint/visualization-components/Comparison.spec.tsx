...
describe('CarbonFootprint - CO2 Comparison', () => {
    it('should use correct style', async () => {
        CustomRender(<Comparison co2Equivalents={25} />);
