import { AssetAdministrationShellRepositoryAPIApiInterface } from 'lib/api/aas/apis';
import {
...
import { ISubmodelRepositoryApi, SubmodelElementValue } from 'lib/api/basyx-v3/apiInterface';
...
export class AssetAdministrationShellRegistryAPIApiInMemory
