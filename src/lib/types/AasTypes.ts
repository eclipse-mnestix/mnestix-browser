 ...
 * @export
 */
export const ServiceDescriptionProfilesEnum = {
    AssetAdministrationShellServiceSpecificationSsp001:
        'https://admin-shell.io/aas/API/3/0/AssetAdministrationShellServiceSpecification/SSP-001',
    AssetAdministrationShellServiceSpecificationSsp002:
